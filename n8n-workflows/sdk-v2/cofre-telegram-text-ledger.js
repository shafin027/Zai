// cofre-telegram-text-ledger.js — Cofre's Telegram entry-point (text-only, no TTS/STT).
...
export default workflow('cofre-telegram-text-ledger', 'Cofre Telegram Text Ledger')
  .add(tgWebhook)
  .to(verifyHmac)
  .to(ifStart)
  .onTrue(
