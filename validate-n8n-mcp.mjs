...
// Save workflow JSON for n8n-mcp validation
import { writeFileSync } from 'fs';
writeFileSync('/tmp/workflow-built.json', JSON.stringify(built, null, 2));
console.log('Workflow JSON saved to /tmp/workflow-built.json');
console.log('Nodes:', built.nodes.length);
console.log('Connections:', Object.keys(built.connections).length);
